function orders() {
    ...
    function push_ajax(parameter_url, settlement_type) {
        $.ajax({
                type: 'get',
                url: baseUrl + '/orders/' + username + "/advance/" + parameter_url,
                datatype: 'json',
                ...
                success: function (response) {
                            ...
                            if (receiverName && receiverState && receiverCity && receiverDistrict && receiverAddress &&
                                ...
                                $.ajax({
                                    ...
                                    data: JSON.stringify({
                                        ...
                                        "address": receiverState + receiverCity + receiverDistrict + receiverAddress,
                    ...
                    $("#go_pay").click(function () {
                        ...
                        console.log("请求发送")
                        console.log("当前在确认订单页")
                        console.log("购买数量是", buy_count);
                        console.log("商品id是", sku_id);
                        if (buy_count && sku_id) {
